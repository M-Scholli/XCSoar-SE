...
#ifndef XCSOAR_INFOBOX_CONTENT_COMBINEDTASK_HPP
#define XCSOAR_INFOBOX_CONTENT_COMBINEDTASK_HPP

#include "InfoBoxes/Content/Base.hpp"

extern const InfoBoxPanel combined_next_waypoint_infobox_panels[];

class InfoBoxContentCombinedNextWaypoint : public InfoBoxContent
{
public:
